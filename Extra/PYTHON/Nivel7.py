...
# A. dormir
# dia_semana Ã© True para dias na semana
# feriado Ã© True nos feriados
# vocÃª pode ficar dormindo quando Ã© feriado ou nÃ£o Ã© dia semana
# retorne True ou False conforme vocÃª vÃ¡ dormir ou nÃ£o
...
# temos problemas quando ambos estÃ£o sorrindo ou ambos nÃ£o estÃ£o sorrindo
# retorne True quando houver problemas
def alunos_problema(a_sorri, b_sorri):
  return 

# C. soma_dobro
# dados dois nÃºmeros inteiros retorna sua soma
# porÃ©m se os nÃºmeros forem iguais retorna o dobro da soma
# soma_dobro(1, 2) -> 3
# soma_dobro(2, 2) -> 8
def soma_dobro(a, b):
  return
...
# retorna True se um dos dois Ã© 10 ou a soma Ã© 10
def dez(a, b):
  return 
